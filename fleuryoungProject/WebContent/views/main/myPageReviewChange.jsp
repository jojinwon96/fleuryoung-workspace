                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="orderInfo" style="width:80%; margin-left: 50px; float: left;">
                                <p>상품명 : <%= p.getpName() %></p>
                                <p>주문번호 : <%= p.getOrdId() %></p>
                                <textarea name="reviewDetail" placeholder="내용을 입력해주세요" style="width: 350px; height: 100px; resize: none;"><%= p.getMemOrderDetail() %></textarea> <br> <br>
                            </div>
							<% } %>
