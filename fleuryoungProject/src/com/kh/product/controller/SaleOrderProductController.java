...
/**
 * Servlet implementation class SaleOrderProductController
 */
@WebServlet("/saleorder.p")
public class SaleOrderProductController extends HttpServlet {
	private static final long serialVersionUID = 1L;

	/**
	 * @see HttpServlet#HttpServlet()
	 */
	public SaleOrderProductController() {
		super();
