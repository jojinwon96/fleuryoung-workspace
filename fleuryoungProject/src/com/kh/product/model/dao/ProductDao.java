...
public class ProductDao {
	...
	public ArrayList<Product> wishList(Connection conn, String mId) {
		...
		try {
			...
			while (rs.next()) {
				list.add(new Product(rs.getString("P_NAME"), (rs.getInt("P_NETPRICE") + ""), rs.getString("P_IMG1"),
						rs.getInt("DISCOUNT"), rs.getInt("TOTAL"), rs.getInt("P_ID")));
			}
	...
	public ArrayList<Order> orderList(Connection conn, String memId) {
		...
		try {
			...
			while (rs.next()) {
				list.add(new Order(rs.getString("P_NAME"), rs.getInt("ORD_ID"), rs.getInt("OD_COUNT"),
						rs.getString("MEM_ID"), rs.getInt("OPTION_1ND_NO"), rs.getInt("OPTION_2ND_NO"),
						rs.getInt("OD_PRICE"), rs.getString("OPTION_2ND_TITLE"), rs.getInt("OPTION_PRICE"),
						rs.getInt("P_ID"), rs.getString("OPTION_2ND_CONTENT"), rs.getString("P_IMG1")));
			}
	...
	public ArrayList<Product> myPageReview(Connection conn, String memId) {
		...
		try {
			...
			while (rs.next()) {
				list.add(new Product(rs.getString("P_NAME"), rs.getInt("ORD_ID"), rs.getString("REVIEW_DETAIL")));
			}
		...
		try {
			...
			while (rset.next()) {
				categoryList.add(new Category(
						...
						rset.getInt("CATEGORY_NO"), rset.getString("CATEGORY_DETAIL"), rset.getString("CATEGORY_NAME")
