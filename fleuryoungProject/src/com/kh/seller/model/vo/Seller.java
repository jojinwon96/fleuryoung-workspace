...
public class Seller {
	...
	public Seller(int selNo, String selId, String selPw, String selBusinessNo, String selStoreName, String selName,
			...
			String selAddress, String selImg, String selStatus, Date selEnrollDate, String pImg1, String address) {
		super();
		this.selNo = selNo;
		this.selId = selId;
		this.selPw = selPw;
	...
	public Seller(String selStoreName, String selTel, String pImg1, String address) {
		super();
		this.selStoreName = selStoreName;
		this.selTel = selTel;
		this.pImg1 = pImg1;
	...
	public String toString() {
		return "Seller [selNo=" + selNo + ", selId=" + selId + ", selPw=" + selPw + ", selBusinessNo=" + selBusinessNo
				+ ", selStoreName=" + selStoreName + ", selName=" + selName + ", selEmail=" + selEmail + ", selPhone="
				+ selPhone + ", selTel=" + selTel + ", selFax=" + selFax + ", selPostal=" + selPostal + ", selStreet="
				+ selStreet + ", selAddress=" + selAddress + ", selImg=" + selImg + ", selStatus=" + selStatus
				+ ", selEnrollDate=" + selEnrollDate + ", pImg1=" + pImg1 + ", address=" + address + "]";
	}
