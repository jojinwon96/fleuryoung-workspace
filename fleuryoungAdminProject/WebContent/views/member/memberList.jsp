                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <form>
                                            ...
                                            <div class="text-end">
                                                <button type="submit" class="btn btn-primary" onclick="return userEnroll();">Save Changes</button>
                                            </div>
                                            <script>
                                                                ...
                                                                <form>
                                                                    ...
                                                                    <div id="addressArea" class="row form-groups">
																		...
																		<div id="addressDiv2" class="col-sm-6"> 
																			...
																			<button id="btn-address" onclick="sample6_execDaumPostcode<%= m.getMemId() %>()" type="button" >주소검색</button>  <br>
