...
<div class="page-header">
    <div class="col-xl-15 col-md-15">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<%=contextPath %>/myPage.se" method="post"
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" placeholder="사업자번호를 입력하세요(숫자)"
                                value="<%=loginSeller.getSelBusinessNo() %>" name="selBusinessNo"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="phone" class="form-control" id="phone"
                                ...
                                value="<%=loginSeller.getSelPhone() %>" name="selPhone">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="phone" class="form-control" id="tel"
                                placeholder="숫자만 입력하세요" value="<%=loginSeller.getSelTel() %>"
                                name="selTel">
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="phone" class="form-control" id="phone"
                                placeholder="숫자만 입력하세요" value="<%=loginSeller.getSelFax() %>"
                                name="selFax">
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="address1" placeholder="우편번호" name="selPoster"
                                class="form-control-sm" value="<%=loginSeller.getSelPostal() %>">
                            <input type="button" class="btn btn-primary btn-md" onclick="juso();"
                                value="우편번호 찾기"><br>
                        </div>
                    </div>
                    ...
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="address2" placeholder="주소"
                                name="selStreet" value="<%=loginSeller.getSelStreet() %>" required>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="address3" placeholder="상세주소"
                                name="selAddress" value="<%=loginSeller.getSelAddress()%>" required>
                        </div>
                    </div>
