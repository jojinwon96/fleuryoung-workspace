...
//        Seller s = new SellerService().selectSeller(selNo);
//       
//        if(s==null || !s.getSelEmail().equals(email))
//        {
...
//        String user = "chlalstn0123@naver.com"; //자신의 네이버 계정
//        String password = "qwer1234";//자신의 네이버 패스워드
//        
//        //메일 받을 주소
//        String to_email = s.getSelEmail();
//        
//        //SMTP 서버 정보를 설정한다.
...
//            
//            //메일 제목
//            msg.setSubject("Flower에서 보낸 인증 메세지입니다.");
//            //메일 내용
...
//        request.setAttribute("id", s.getSelId());
